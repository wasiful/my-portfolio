...
For educational purpose, worked on many projects can be found in my git hub. Build an app Curvature to extract equations from objects in images.
Here are some featured projects and research contributions, many more projects are ongoing:
- [Curvature: Turn all the design around you into equations](https://curvature.figma.site/)
